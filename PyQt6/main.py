...
class Main(QWidget):
    def __init__(self):
        ...
        self.ui.btn_video.clicked.connect(self.startExternalVideo)
        self.ui.car_box.clicked.connect(self.carBox)
        self.ui.signs_box.clicked.connect(self.signsBox)
        self.ui.people_box.clicked.connect(self.peopleBox)
        self.ui.other_box.clicked.connect(self.otherBox)
